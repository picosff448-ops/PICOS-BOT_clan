...
ADMIN_UID = "14333389660"  # Your admin UID
server2 = "ME"
key2 = "MAHFUJ"
                        ...
                        if inPuTMsG.startswith('/join'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    if can_send_emote_to(sender_uid) and can_send_emote_to(14333389660):
...
async def MaiiiinE():
    Uid, Pw = '4385084752', '03A385C3A7AA863966D763020897EE4EF0A2774985991004E2849DA8D11405F2'
